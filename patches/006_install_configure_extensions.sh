...
#! commented out because I'm unsure of its functionality, especially considering that I'm definitely looking to add the 'Customised Workspaces' and 'Customize Clock on Lock Screen' extensions which involve
#!	having one wallpaper for each workspace
